        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            {contacts.map((c, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${c.color} flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform`}
                >
